    ...
    >
      ...
      <div className="flex items-center justify-between">
        ...
        <Button
          ...
          size="sm"
          className="bg-white/20 hover:bg-white/30 text-white border-white/30 rounded-lg text-xs px-3 py-1.5"
        >
      ...
      <div className="space-y-2">
        ...
        <motion.button
          ...
          className={cn(
            "w-full flex items-center justify-between p-3 rounded-lg transition-all duration-200 text-right text-sm",
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-200 flex items-center gap-1">
                  <Button
                    ...
                    className="h-6 w-6 p-0 text-white/80 hover:text-white hover:bg-white/10 rounded"
                  >
                  ...
                  <Button
                    ...
                    className="h-6 w-6 p-0 text-red-300 hover:text-red-200 hover:bg-red-500/20 rounded"
                  >
