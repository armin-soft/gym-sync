...
export const CategoryManager: React.FC<CategoryManagerProps> = ({
  ...
  return (
    <div className="bg-white rounded-3xl shadow-2xl border border-gray-100 p-8 mb-8" dir="rtl">
      <div className="flex items-center justify-between mb-6">
        ...
        <Button
          ...
          className={`bg-gradient-to-r ${getGradientColors()} ${getHoverColors()} text-white shadow-lg rounded-2xl px-6 py-3`}
        >
      ...
      {filteredCategories.length === 0 ? (
        <div className="text-center py-16">
          <div className={`w-20 h-20 bg-gradient-to-br ${getGradientColors()} rounded-3xl flex items-center justify-center mx-auto mb-4`}>
          ...
          <Button
            onClick={onAddCategory}
            className={`bg-gradient-to-r ${getGradientColors()} ${getHoverColors()} text-white shadow-lg rounded-2xl px-8 py-3`}
          >
            <Plus className="w-5 h-5 ml-2" />
            ایجاد دسته‌بندی
          </Button>
