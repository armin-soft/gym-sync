...
import { Pill, Sparkles, Plus, Search, Filter, Grid3X3, List, Settings2 } from "lucide-react";
...
export const AdvancedSupplementTabs: React.FC<AdvancedSupplementTabsProps> = ({
      ...
      <div className="flex items-center justify-center h-full">
        ...
        >
          <div className="relative">
            ...
            <div className="w-12 h-12 border-4 border-blue-200 border-t-blue-600 rounded-full animate-spin absolute top-2 left-2 animate-reverse"></div>
          </div>
          <p className="text-slate-600 text-lg font-medium">در حال بارگذاری...</p>
        </motion.div>
      </div>
    );
  }
  ...
  return (
    <motion.div 
      ...
      className="flex flex-col h-full bg-white/40 backdrop-blur-sm rounded-3xl border border-white/60 shadow-xl overflow-hidden"
      dir="rtl"
    >
      {/* Advanced Header */}
      <div className="bg-gradient-to-l from-purple-600 via-indigo-600 to-blue-600 p-6">
          ...
          <div className="flex-1 flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
            <div className="relative flex-1">
              ...
              <Input
                ...
                className="pr-12 pl-4 bg-white/20 border-white/30 text-white placeholder:text-white/60 rounded-xl focus:bg-white/30 focus:border-white/50"
              />
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <Button
                ...
                className="bg-white/20 hover:bg-white/30 text-white border-white/30 rounded-xl shadow-lg"
              >
      ...
      {/* Footer Stats */}
      <div className="bg-gradient-to-l from-slate-50 to-purple-50/50 p-4 border-t border-slate-200">
