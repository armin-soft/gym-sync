...
export type StudentQuickActionColor = "emerald" | "sky" | "orange" | "purple" | "pink" | "indigo";

export interface StudentQuickActionCardProps {
  title: string;
  description: string;
  icon: LucideIcon;
  color: StudentQuickActionColor;
  path: string;
  onClick?: () => void;
}
...
export const StudentQuickActionCard = ({
  title,
  description,
  icon: Icon,
  color,
  ...
  return (
    <motion.div
      ...
      whileTap={{ scale: 0.98 }}
      className={`relative overflow-hidden rounded-2xl bg-gradient-to-br ${colors.bg} border ${colors.border} p-6 cursor-pointer group`}
