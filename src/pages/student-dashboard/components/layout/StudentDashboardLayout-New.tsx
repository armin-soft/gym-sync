...
interface StudentDashboardLayoutNewProps {
  children: ReactNode;
}
...
export const StudentDashboardLayoutNew = ({ children }: StudentDashboardLayoutNewProps) => {
  ...
  return (
    ...
    >
      {/* پس‌زمینه گرادیانی مشابه پنل مدیریت */}
...
export default StudentDashboardLayoutNew;
