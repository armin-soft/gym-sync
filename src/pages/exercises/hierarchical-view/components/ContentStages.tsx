    ...
    <div className="mb-6">
      <div className="flex items-center">
        ...
        <div className={`flex items-center ${currentStage === 'categories' ? 'text-primary' : currentStage === 'exercises' ? 'text-primary' : 'text-muted-foreground'}`}>
          <span className={`flex h-8 w-8 items-center justify-center rounded-full ${currentStage === 'categories' || currentStage === 'exercises' ? 'bg-primary/10 text-primary' : 'bg-muted text-muted-foreground'}`}>2</span>
