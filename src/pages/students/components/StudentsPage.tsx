        ...
        <div className={`w-full h-full flex flex-col mx-auto ${getContentPadding()} py-3 sm:py-4 md:py-6`}>
          <StudentProgramManager 
            ...
            onSaveExercises={(exercisesWithSets, dayNumber) => 
              handleSaveExercisesWithHistory(exercisesWithSets, selectedStudentForProgram.id, dayNumber)
            }
            onSaveDiet={(mealIds) => 
              handleSaveDietWithHistory(mealIds, selectedStudentForProgram.id)
            }
            onSaveSupplements={(data) => 
              handleSaveSupplementsWithHistory(data, selectedStudentForProgram.id)
            }
            ...
            <AnimatePresence mode="wait">
              ...
              >
                <StudentsTable 
                  ...
                  onAddExercise={handleOpenProgramManager}  // Changed this to use our program manager
                  onAddDiet={handleOpenProgramManager}      // Changed this to use our program manager
                  onAddSupplement={handleOpenProgramManager}  // Changed this to use our program manager
