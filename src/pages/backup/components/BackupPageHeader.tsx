...
export function BackupPageHeader() {
  ...
  return (
    <motion.div variants={itemVariants} className="text-center mb-6 sm:mb-8 lg:mb-12">
      <div className="inline-flex items-center justify-center w-16 h-16 sm:w-18 sm:h-18 md:w-20 md:h-20 bg-gradient-to-br from-gold-500 to-bronze-600 rounded-xl sm:rounded-2xl shadow-lg mb-4 sm:mb-6">
        <Shield className="w-8 h-8 sm:w-9 sm:h-9 md:w-10 md:h-10 text-white" />
      </div>
      <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold bg-gradient-to-r from-gold-600 via-gold-500 to-bronze-600 bg-clip-text text-transparent mb-3 sm:mb-4 leading-tight">
