...
const BackupPage = () => {
  ...
  return (
    <PageContainer 
      noPadding 
      fullHeight 
      className="overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-slate-900 dark:via-blue-950 dark:to-indigo-950"
    >
      <div className="h-full overflow-y-auto overflow-x-hidden">
        <motion.div 
          ...
          initial="hidden"
          animate="visible"
          className="container mx-auto px-2 xs:px-3 sm:px-4 md:px-6 lg:px-8 py-4 sm:py-6 md:py-8 lg:py-12 max-w-7xl"
          dir="rtl"
        >
