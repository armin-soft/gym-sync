  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        secondary: "bg-gold-500 text-white hover:bg-gold-600 shadow-sm border border-gold-500/20 hover:shadow-md",
        ghost: "hover:bg-accent hover:text-accent-foreground",
        link: "text-brand-500 underline-offset-4 hover:underline",
        gradient: "bg-gradient-to-r from-brand-500 to-gold-500 hover:from-brand-600 hover:to-gold-600 text-white shadow-sm hover:shadow-md border border-brand-500/10",
        dark: "bg-dark-800 text-white hover:bg-dark-700 shadow-sm border border-dark-800/20 hover:shadow-md",
