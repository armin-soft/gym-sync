    ...
    <div className="space-y-2 text-right">
      <div className="flex justify-between items-center">
        <Button
          ...
          className={`text-xs h-8 flex items-center gap-1.5 ${showSpeech ? "bg-indigo-600 hover:bg-indigo-700 text-white" : ""}`}
        >
          {showSpeech ? <Wand2 className="h-3.5 w-3.5 ml-1.5" /> : <Mic className="h-3.5 w-3.5 ml-1.5" />}
