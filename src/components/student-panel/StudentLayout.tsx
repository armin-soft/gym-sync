...
export const StudentLayout = ({ children, student, onLogout }: StudentLayoutProps) => {
  ...
  return (
    <div className="h-screen w-full bg-gradient-to-br from-violet-50 via-white to-indigo-50 dark:from-violet-950 dark:via-gray-900 dark:to-indigo-950 persian-numbers flex flex-col overflow-hidden" dir="rtl">
      {/* Student Sidebar */}
      {sidebarOpen && (
        <StudentSidebar 
          isOpen={sidebarOpen} 
