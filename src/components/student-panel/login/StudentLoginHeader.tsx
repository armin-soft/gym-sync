  ...
  return (
    <motion.div variants={variants} className="text-center mb-8">
      <div className="relative inline-block">
        <motion.div
          className="w-20 h-20 mx-auto mb-4 bg-gradient-to-br from-emerald-600 to-sky-600 rounded-3xl flex items-center justify-center shadow-2xl"
      ...
      <h1 className="text-3xl font-bold bg-gradient-to-r from-emerald-700 to-sky-700 bg-clip-text text-transparent mb-2">
        ورود به پنل شاگرد
      </h1>
