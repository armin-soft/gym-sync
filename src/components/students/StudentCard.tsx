    ...
    >
      ...
      >
        <Card className={cn(
          ...
          "hover:shadow-xl hover:shadow-emerald-200/10 dark:hover:shadow-emerald-900/20",
          "transition-all duration-300 ease-in-out group",
          className
        )}>
          {/* Animated gradient background on hover */}
          <div className="absolute inset-0 bg-gradient-to-br from-emerald-400/5 via-sky-400/5 to-emerald-400/5 
                        opacity-0 group-hover:opacity-100 transition-opacity duration-500 -z-10"></div>
          
          {/* Top right decorative shape */}
          <div className="absolute -top-8 -right-8 w-20 h-20 rounded-full bg-gradient-to-br from-emerald-500/10 to-sky-500/10 
                        blur-xl dark:from-emerald-500/20 dark:to-sky-500/20"></div>
          
          {/* Bottom left decorative shape */}
          <div className="absolute -bottom-10 -left-10 w-24 h-24 rounded-full bg-gradient-to-br from-sky-500/10 to-emerald-500/10 
                        blur-xl dark:from-sky-500/20 dark:to-emerald-500/20"></div>
