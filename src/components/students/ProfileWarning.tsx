...
export const ProfileWarning: React.FC<ProfileWarningProps> = ({ isProfileComplete, className }) => {
  ...
  return (
    ...
    >
      <Alert variant="warning" className="backdrop-blur-md bg-amber-50/90 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 text-amber-800 dark:text-amber-300">
