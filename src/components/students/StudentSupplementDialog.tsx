...
import { 
  Search, Save, X, Check, ChevronLeft, Pill, FlaskConical, 
  Sparkles, LayoutGrid, ListFilter, SlidersHorizontal, Info
} from "lucide-react";
...
export function StudentSupplementDialog({
  ...
  const [activeItem, setActiveItem] = useState<Supplement | null>(null);
  ...
  const getTotalSelected = () => {
    if (activeTab === "supplements") {
      return toPersianNumbers(selectedSupplements.length);
    } else {
      return toPersianNumbers(selectedVitamins.length);
    }
  };
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent 
        side="right" 
        className="w-full sm:max-w-full lg:max-w-full p-0 flex flex-col border-0 text-right"
        dir="rtl"
      >
                      ...
                      {filteredItems.map((item) => {
                        ...
                        return (
                          ...
                          >
                            <div
                              className={cn(
                                "p-4 rounded-xl border shadow-sm transition-all cursor-pointer hover:shadow",
                                isItemSelected
                                  ? activeTab === "supplements"
                                ...
                                <div className="space-y-2 text-right">
                                  <div>
                                    ...
                                    <div className="flex flex-wrap gap-1.5 mt-1.5">
                                      <span className={`text-xs px-2 py-0.5 rounded-full border flex items-center gap-1 ${getItemTypeColor(item.type)}`}>
                            ...
                            >
                              <div className="flex gap-3">
                                ...
                                <div className="flex-1 text-right">
                                  ...
                                  {item.description && (
                                    <div className="mt-2 flex gap-1 items-start justify-end">
          ...
          <SheetFooter className="border-t p-4 mt-auto bg-muted/20 shrink-0 flex-row gap-2 justify-between">
            <div className="flex items-center gap-2">
              ...
              >
                ...
                {activeTab === "supplements" 
                  ? `${getTotalSelected()} مکمل انتخاب شده`
                  : `${getTotalSelected()} ویتامین انتخاب شده`
                }
              </motion.div>
            </div>
