  ...
  return (
    <div className="min-h-screen w-full overflow-hidden bg-gradient-to-br from-slate-50 via-emerald-50/30 to-sky-50/40 dark:from-slate-900 dark:via-emerald-950/30 dark:to-sky-950/40">
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 py-8">
        <motion.div
          variants={variants}
          className="backdrop-blur-xl bg-gradient-to-br from-emerald-500/10 via-sky-500/10 to-emerald-600/10 border border-emerald-300/30 dark:border-emerald-700/30 rounded-3xl shadow-2xl p-8 sm:p-10 max-w-2xl w-full"
          dir="rtl"
        >
          {/* نماد قفل مرکزی */}
          <motion.div 
