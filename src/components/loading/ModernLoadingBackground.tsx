...
import { Shield, Users, GraduationCap, Dumbbell, Target, Trophy, Zap, Heart } from "lucide-react";

const floatingIcons = [
  { icon: Shield, delay: 0, x: "10%", y: "20%" },
  { icon: Users, delay: 0.5, x: "85%", y: "25%" },
  { icon: GraduationCap, delay: 1, x: "15%", y: "70%" },
  { icon: Dumbbell, delay: 1.5, x: "80%", y: "65%" },
  { icon: Target, delay: 2, x: "25%", y: "40%" },
  { icon: Trophy, delay: 2.5, x: "75%", y: "45%" },
  { icon: Zap, delay: 3, x: "50%", y: "15%" },
  { icon: Heart, delay: 3.5, x: "45%", y: "80%" },
];

export const ModernLoadingBackground = () => {
  return (
