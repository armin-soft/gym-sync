...
import { StudentStatsGrid } from "./header/StudentStatsGrid";
import { useSidebarDimensions } from "@/components/modern-sidebar/utils/deviceUtils";
import { StudentProfile, StudentSidebarStats } from "../types/studentSidebarTypes";

interface StudentSidebarHeaderProps {
  profile: StudentProfile;
  stats: StudentSidebarStats;
  onClose: () => void;
}

export const StudentSidebarHeader: React.FC<StudentSidebarHeaderProps> = ({
  profile,
  stats,
  onClose
}) => {
