...
// تمیز کردن درخواست‌ها
self.createCleanRequest = function(request) {
  const url = new URL(request.url);
  
  // اصلاح مسیرها با حروف بزرگ/کوچک متفاوت
  if (url.pathname.includes('/assets/') && !url.pathname.includes('/Assets/')) {
    url.pathname = url.pathname.replace('/assets/', '/Assets/');
  }
...
console.log('[Service Worker] فایل توابع کمکی بارگذاری شد');
